                    ...
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <h3 class="text-white mb-0 font-weight-500">3400 <small
                                        class="text-success"><i class="fa fa-caret-up"></i> +2.5%</small>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <h3 class="text-white mb-0 font-weight-500">$1,250 <small
                                        class="text-danger"><i class="fa fa-caret-down"></i> -0.5%</small>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <h3 class="text-white mb-0 font-weight-500">1,460 <small
                                        class="text-danger"><i class="fa fa-caret-up"></i> -1.5%</small>
                                </h3>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table no-border">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-primary-light badge-lg">Approved</span>
                                            </td>
                                            <td class="text-right">
                                                <a href="#"
