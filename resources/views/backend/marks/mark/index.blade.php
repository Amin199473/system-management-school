                ...
                <div class="row">
                    <div class="col-12">
                        <div class="box bb-3 border-warning">
                            ...
                            <div class="box-body">
                                <form action="{{ route('marksEntryStore') }}" method="POST">
                                    @csrf
                                    @method("POST")
                                    <div class="row pb-4">
                                        <div class="col-md-3">
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, v) {
                        html +=
                            ...
                            '<td><input type="text" class="form-control form-control-sm" name="marks[]"></tr>';
                    });
