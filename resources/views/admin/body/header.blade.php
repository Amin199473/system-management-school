            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0" data-toggle="dropdown"
                        title="User">
                        <img class="bg-white" src="{{!empty(Auth::user()->image)? url('upload/user_images/'.Auth::user()->image) : url('upload/avatar-1.png') }}" alt="">
                    </a>
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            <a class="dropdown-item" href="{{ route('profile.index') }}"><i class="ti-user text-muted mr-2"></i>
                                Profile</a>
