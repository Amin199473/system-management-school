            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Edit Employee Attendacne</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                {{-- start form --}}
                                <form method="POST" action="{{ route('employeeAttendance.update',$attendance[0]['date']) }}" enctype="multipart/form-data" novalidate="">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="date" value="{{$attendance[0]['date']}}" name="date" id="date" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-bordered table-striped" style="width: 100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="text-center" id="div{{$attend->id}}" >
