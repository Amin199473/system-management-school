                                ...
                                <div class="row pb-4">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <h5>Exam Type</h5>
                                            <div class=controls>
                                                <select name="examType_id" id="examType_id" required="" class="form-control">
    ...
    <script type="text/javascript">
        $(document).on('click','#search',function(){
          ...
          var examType_id = $('#examType_id').val();
           $.ajax({
            url: "{{ route('examFee.create')}}",
            type: "get",
            data: {'year_id':year_id,'class_id':class_id,'examType_id':examType_id},
            beforeSend: function() {
            },
