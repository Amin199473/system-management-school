                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($designations as $key=>$designation )
                                                <tr>
                                                    ...
                                                    <td width="25%">
                                                        <div class="row">
                                                            <a href="{{ route('designation.edit',$designation->id) }}" class="btn btn-info ml-2">Edit</a>

                                                            <form method="POST" action="{{ route("designation.destroy" ,$designation->id) }}" id="form" class="form-inline">
                                                                @csrf
                                                                @method('DELETE')
